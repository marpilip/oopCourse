...
public class Main {
    public static void main(String[] args) {
        ...
        double[] d1 = {2, 3, 4, 6};
        double[] d2 = {5, 6, 7};
        Vector vector1 = new Vector(d1);
        Vector v2 = new Vector(d2);

        Vector[] vs = {vector1, v2};
        Matrix matrix3 = new Matrix(vs);
        ...
        double[] d4 = {20, 25, 30, 40};
        Vector vector2 = new Vector(d4);
        matrix3.setRow(1, vector2);
        ...
        Matrix matrix6 = new Matrix(d);
        double[] doubles4 = {2, -3, 5};
        Vector vector = new Vector(doubles4);
        ...
        double[][] d6 = {{1, 2, 5, 32}, {7, 5, 6, 12}, {7, 20, 9, 10}, {1, 2, 3, 4}};
        Matrix matrix5 = new Matrix(d6);
        System.out.println("Определитель матрицы = " + matrix5.getDeterminant());
        System.out.println();

        double[][] d7 = {{1, 2}, {4, 5, 6}};
        Matrix matrix7 = new Matrix(d7);
        double[][] d8 = {{4, 50, 61}, {10, 20, 30}};
        Matrix matrix8 = new Matrix(d8);
        ...
        double[][] d9 = {{10, 15}, {13, 34}, {12, 14}};
        Matrix matrix9 = new Matrix(d9);
